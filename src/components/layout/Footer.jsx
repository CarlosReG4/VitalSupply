  ...
  return (
    <footer className="bg-slate-900 text-slate-300 font-sans py-16 border-t border-slate-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-white font-bold text-[11px] tracking-widest uppercase">Got questions? Call us:</h4>
            ...
            <div className="space-y-4 pt-4">
              <div>
                <span className="block text-white font-bold text-[11px] tracking-widest uppercase mb-1">Email:</span> 
          ...
          <div className="lg:col-span-3 space-y-6 pt-4 lg:pt-16">
             <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-white font-bold text-[11px] tracking-widest uppercase">We use secure payments</h4>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 lg:border-l lg:border-slate-700 lg:pl-8 lg:pt-4">
            ...
            <ul className="space-y-3 text-sm font-semibold">
              ...
              <li><Link to="/contacto" className="hover:text-blue-400 transition-colors">Contact</Link></li>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 pt-8 border-t border-slate-800 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 font-semibold">
        ...
        <p className="mt-2 md:mt-0">Built with technical precision for the medical sector.</p>
      </div>
    </footer>
  );
}