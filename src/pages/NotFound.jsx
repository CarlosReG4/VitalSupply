...
function NotFound() {
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col items-center justify-center text-center px-4 py-20">
      ...
      <h1 className="text-2xl font-bold text-gray-800 mb-3">{t('notFound.title')}</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        >
          <i className="fas fa-home"></i> {t('notFound.goHome')}
        </Link>
        <Link
          to="/tienda"
        ...
        >
          <i className="fas fa-store"></i> {t('notFound.viewShop')}
        </Link>
      </div>
    </div>
  );
